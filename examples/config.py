...
parser.add_argument("--last_break", type=float, default=2.4)
# for MD17
...
parser.set_defaults(energy_force_with_normalization=True)

# about training strategies
parser.add_argument("--split", type=str, default="customized_01", choices=["customized_01", "customized_02", "random"])
...
parser.set_defaults(use_rotation_transform=True)

# for GTAM_3D
parser.add_argument("--num_filters_3D", type=int, default=128)
parser.add_argument("--num_interactions_3D", type=int, default=6)
parser.add_argument("--num_gaussians_3D", type=int, default=51)
parser.add_argument("--cutoff_3D", type=float, default=10)
parser.add_argument("--readout_3D", type=str, default="mean", choices=["mean", "add"])
...
### for masking
parser.add_argument("--SSL_masking_ratio", type=float, default=0) # 0.15

### for 2D-3D pair Loss
parser.add_argument("--Pair_2Dto3D_coeff", type=float, default=0.05)
parser.add_argument("--Pair_3Dto2D_coeff", type=float, default=0.05)

### for 2D-3D Contrastive SSL
parser.add_argument("--CL_neg_samples", type=int, default=0.1)
parser.add_argument("--CL_similarity_metric", type=str, default="EBM_node_dot_prod",
...
parser.add_argument("--hidden_dim_2Dto3D", type=int, default=32)
parser.add_argument("--beta_min_2Dto3D", type=int, default=0.2)
parser.add_argument("--beta_max_2Dto3D", type=int, default=1.0)
parser.add_argument("--num_diffusion_timesteps_2Dto3D", type=int, default=1000)
parser.add_argument("--beta_min_3Dto2D", type=int, default=0.1)
parser.add_argument("--beta_max_3Dto2D", type=int, default=1.0)
parser.add_argument("--num_diffusion_timesteps_3Dto2D", type=int, default=1000)
# parser.add_argument("--SDE_type_3Dto2D", type=str, default="VE")
# parser.add_argument("--SDE_2Dto3D_model", type=str, default="SDEModel2Dto3D_02")
